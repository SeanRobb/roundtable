...
import styles from './werewolfPlayroom.module.css';
...
// TODO build playroom for different games
  return (
  <div className={styles.WerewolfPlayroom} data-testid="WerewolfPlayroom">
...
WerewolfPlayroom.propTypes = {
};

WerewolfPlayroom.defaultProps = {};

export default WerewolfPlayroom;
